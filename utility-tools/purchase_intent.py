...
tool_config = {
    ...
    "function": {
        ...
        "description":
        "Detects user interest en un producto o servicio, recopila la información de contacto del usuario y la envía a través de un webhook.",
        "parameters": {
            "type": "object",
            "properties": {
                "name": {
                ...
                "conversation_summary": {
                    ...
                    "string",
                    "description":
                    "Resumen breve de la conversación (menos de 30 palabras)."
                }
            },
            "required":
            ["name", "email", "phone_number", "conversation_summary"]
        }
    }
}
